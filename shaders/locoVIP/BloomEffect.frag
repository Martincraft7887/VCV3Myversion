...
void main()
{
    ...
    color += flixel_texture2D(bitmap, clamp(uv + (off1 / iResolution), vec2(0.001), vec2(0.999))) * 0.3162162162 * strength;
    color += flixel_texture2D(bitmap, clamp(uv - (off1 / iResolution), vec2(0.001), vec2(0.999))) * 0.3162162162 * strength;
    color += flixel_texture2D(bitmap, clamp(uv + (off2 / iResolution), vec2(0.001), vec2(0.999))) * 0.0702702703 * strength;
    color += flixel_texture2D(bitmap, clamp(uv - (off2 / iResolution), vec2(0.001), vec2(0.999))) * 0.0702702703 * strength;
