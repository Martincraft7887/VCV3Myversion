...
function createPost()
	...
	if modcharts then 
		...
		if keyCount == 7 then 
			noteWidth = 160*getActorScaleX(0)
		end
		

		local pos = 640+(noteWidth*keyCount*0.5)
...
function updateCams(elapsed)
	if movecams then 
		...
		for i = 0,4 do 
			pos = -noteWidth*keyCount*2
	
			pos = (((camOffsetTime*140) + (noteWidth*keyCount*i)) % (noteWidth*keyCount*5))-noteWidth*(keyCount*2)
...
function stepHit()
	...
	if (section >= 0 and section < 40) or (section >= 72 and section < 76) then 
		...
		if keyCount == 7 then 
			if secStep == 0 then 
				...
				setAndEaseBack('note12', 'y', 30, crochet*0.001*16, 'circOut')
				setAndEaseBack('note13', 'y', 30, crochet*0.001*16, 'circOut')
			elseif secStep == 4 then 
				...
				setAndEaseBack('note10', 'y', 30, crochet*0.001*16, 'circOut')
				setAndEaseBack('note11', 'y', 30, crochet*0.001*16, 'circOut')
			elseif secStep == 8 then 
				...
				setAndEaseBack('note8', 'y', 30, crochet*0.001*16, 'circOut')
				setAndEaseBack('note9', 'y', 30, crochet*0.001*16, 'circOut')
			...
			if (section >= 8 and section < 24) or section >= 72 then 
				if section % 4 < 2 then 
					if doubleSecStep == 16 then 
						...
						setAndEaseBack('note12', 'angle', -50, crochet*0.001*8, 'circOut')
						setAndEaseBack('note13', 'angle', -50, crochet*0.001*8, 'circOut')
						setAndEaseBack('angle12', 'angle', -360, crochet*0.001*8, 'circOut')
						setAndEaseBack('angle13', 'angle', -360, crochet*0.001*8, 'circOut')
					elseif doubleSecStep == 18 then 
						...
						setAndEaseBack('note10', 'angle', -50, crochet*0.001*8, 'circOut')
						setAndEaseBack('note11', 'angle', -50, crochet*0.001*8, 'circOut')
						setAndEaseBack('angle10', 'angle', -360, crochet*0.001*8, 'circOut')
						setAndEaseBack('angle11', 'angle', -360, crochet*0.001*8, 'circOut')
					elseif doubleSecStep == 20 then 
						...
						setAndEaseBack('angle8', 'angle', -360, crochet*0.001*8, 'circOut')
						setAndEaseBack('angle9', 'angle', -360, crochet*0.001*8, 'circOut')
	...
	if section >= 24 and section < 72 then 
